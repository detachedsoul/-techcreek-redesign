...
const HeroComponent = () => {
    return ( 
        <div className="min-h-[70vh] grid place-content-center bg-index-hero bg-fixed bg-center bg-cover py-8 px-4 lg:px-[5%]">
            ...
            <div className="space-y-2 lg:w-1/2 tracking-wider text-white">
                ...
                <Link href="/">
                    <a className="bg-blue-700 ease-in-out delay-75 rounded-md py-2 px-4 inline-block hover:bg-default-blue">
                        Get Started
                    </a>
                </Link>
